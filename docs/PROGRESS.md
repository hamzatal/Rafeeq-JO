...
> **العمل الحالي:** أُنجز التدقيق الشامل + الأمان + فهارس قاعدة البيانات + توحيد التصميم (Onyx) + ترتيب التوثيق. **التصميم مُجمَّد على Onyx بقرار المستخدم** (تحسينه آخر خطوة). **التالي:** مراجعة نطاق المزايا (بلا حذف/تأجيل) ثم جودة الكود (PHPStan/Pint).
