...
const TARGETS = [
  {
    ...
    private: [
      // العمليات
      ['01-dashboard', '/', 'لوحة القيادة'],
      ['02-ride-requests', '/ride-requests', 'الطلبات الحيّة'],
      ['03-trips', '/trips', 'الرحلات'],
      ['04-insights', '/insights', 'الرؤى والتحليلات'],
      // الشبكة
      ['05-drivers', '/drivers', 'الكباتن والتوثيق'],
      ['06-users', '/users', 'المستخدمون'],
      ['07-geography-zones', '/geography?tab=zones', 'الجغرافيا — المناطق'],
      ['08-geography-prices', '/geography?tab=prices', 'الجغرافيا — أسعار المناطق'],
      ['09-geography-routes', '/geography?tab=routes', 'الجغرافيا — المسارات'],
      ['10-geography-universities', '/geography?tab=universities', 'الجغرافيا — الجامعات'],
      // المالية
      ['11-payments', '/payments', 'المدفوعات'],
      ['12-withdrawals', '/withdrawals', 'السحوبات'],
      ['13-pricing-tariff', '/pricing?tab=tariff', 'التسعير — التعرفة والعمولة'],
      ['14-pricing-plans', '/pricing?tab=plans', 'التسعير — الباقات'],
      ['15-pricing-subscriptions', '/pricing?tab=subscriptions', 'التسعير — الاشتراكات'],
      ['16-pricing-coupons', '/pricing?tab=coupons', 'التسعير — الكوبونات'],
      ['17-reports', '/reports', 'التقارير المالية'],
      // الثقة والنظام
      ['18-safety', '/safety', 'السلامة و SOS'],
      ['19-support-tickets', '/support?tab=tickets', 'الدعم — التذاكر'],
      ['20-support-complaints', '/support?tab=complaints', 'الدعم — الشكاوى'],
      ['21-disputes', '/disputes', 'التنازعات'],
      ['22-security-sessions', '/security?tab=sessions', 'الأمان — الجلسات والمصادقة'],
      ['23-security-audit', '/security?tab=audit', 'الأمان — سجلّ التدقيق'],
      ['24-settings-staff', '/settings?tab=staff', 'الإعدادات — الموظفون والأدوار'],
      ['25-settings-cliq', '/settings?tab=cliq', 'الإعدادات — إعداد CliQ'],
      ['26-settings-broadcast', '/settings?tab=broadcast', 'الإعدادات — الإشعارات والبثّ'],
      ['27-settings-ads', '/settings?tab=ads', 'الإعدادات — الإعلانات'],
      // من تذييل السايدبار
      ['28-profile', '/profile', 'ملفّي'],
    ],
  },
  {
    name: 'student-app',
