export const ar = {
  ...
  onboarding: {
    skip: 'تخطّي',
    getStarted: 'لنبدأ',
    s1Title: 'خريطتك ورحلتك بمكان واحد',
    s1Body: 'اطلب رحلتك الجامعية بضغطة واحدة، وتابعها مباشرة على الخريطة لحظة بلحظة.',
    s2Title: 'اشترك ووفّر',
    s2Body: 'باقات أسبوعية وشهرية وفصلية على مسارك — بأسعار طلابية واضحة بلا مفاجآت.',
    s3Title: 'آمن وموثوق',
    s3Body: 'كباتن موثّقون، تتبّع مباشر للرحلة، وزر طوارئ عند الحاجة.',
