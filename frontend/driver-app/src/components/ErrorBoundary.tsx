...
const styles = StyleSheet.create({
  root: { flex: 1, backgroundColor: '#06121F', alignItems: 'center', justifyContent: 'center', padding: 28 },
  badge: { width: 72, height: 72, borderRadius: 36, backgroundColor: 'rgba(0,229,255,0.15)', borderWidth: 2, borderColor: '#00E5FF', alignItems: 'center', justifyContent: 'center', marginBottom: 20 },
  badgeText: { fontSize: 36, fontWeight: '800', color: '#00E5FF' },
  ...
  btn: { backgroundColor: '#00E5FF', paddingHorizontal: 28, height: 50, borderRadius: 14, alignItems: 'center', justifyContent: 'center' },
  btnText: { fontSize: 15, fontWeight: '800', color: '#06121F' },
});
