...
/**
 * Build an Arabic (RTL) HTML invoice for a payment request and let the captain
 * save/share it as a PDF — keeping a copy of every transaction on the device.
 */
  ...
  <style>
    *{font-family:-apple-system,'Segoe UI',Tahoma,sans-serif;box-sizing:border-box}
    ...
    <div class="head">
      ...
      <div class="tag">إيصال معاملة<br/>${date}</div>
    </div>
