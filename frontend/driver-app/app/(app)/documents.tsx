...
const makeStyles = (t: AppTheme) =>
  StyleSheet.create({
    ...
    progressText: { fontFamily: t.fontFamily.bold, fontSize: 15, color: t.colors.text },
    ...
    uploadBtn: { flexDirection: 'row-reverse', alignItems: 'center', gap: 5, backgroundColor: t.colors.primary, paddingVertical: 9, paddingHorizontal: 14, borderRadius: t.radius.control },
    uploadText: { color: t.colors.onPrimary, fontFamily: t.fontFamily.bold, fontSize: 13 },

    infoBox: { flexDirection: 'row-reverse', alignItems: 'center', gap: 8, backgroundColor: t.colors.hairline, borderRadius: t.radius.control, padding: t.spacing.md },
