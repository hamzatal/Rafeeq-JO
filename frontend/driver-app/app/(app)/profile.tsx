        ...
        <View style={s.profileCard}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <View style={s.verifiedPill}>
              <Icon name="circle-check" size={12} color={theme.colors.accent} />
...
const makeStyles = (t: AppTheme) =>
  StyleSheet.create({
    ...
    avatarSmText: { fontFamily: t.fontFamily.bold, fontSize: 16, color: t.colors.primary },
    content: { padding: t.spacing.lg, paddingBottom: t.spacing['3xl'] },

    profileCard: { flexDirection: 'row-reverse', alignItems: 'center', gap: t.spacing.lg, backgroundColor: t.colors.surface, borderRadius: t.radius.sheet, borderWidth: 1, borderColor: t.colors.surfaceHighest, padding: t.spacing.lg, overflow: 'hidden', ...t.shadow.sm },
    ...
    name: { fontFamily: t.fontFamily.bold, fontSize: 24, lineHeight: 32, color: t.colors.primary, textAlign: 'right' },
    verifiedPill: { flexDirection: 'row-reverse', alignItems: 'center', alignSelf: 'flex-end', gap: 5, backgroundColor: t.colors.surfaceAlt, borderWidth: 1, borderColor: t.colors.accentSoft, borderRadius: t.radius.pill, paddingHorizontal: 10, paddingVertical: 4, marginTop: 6 },
    ...
    avatarLgText: { fontFamily: t.fontFamily.bold, fontSize: 32, color: t.colors.onPrimary },
    ...
    statCard: { flex: 1, backgroundColor: t.colors.surface, borderRadius: t.radius.card, borderWidth: 1, borderColor: t.colors.hairline, padding: t.spacing.base, ...t.shadow.sm },
    ...
    statValue: { fontFamily: t.fontFamily.bold, fontSize: 32, lineHeight: 40, color: t.colors.primary, textAlign: 'right', marginTop: 6 },
    ...
    vehicleCard: { backgroundColor: t.colors.surface, borderRadius: t.radius.sheet, borderWidth: 1, borderColor: t.colors.hairline, overflow: 'hidden', ...t.shadow.sm },
    ...
    vehicleBadge: { flexDirection: 'row-reverse', alignItems: 'center', gap: 6, backgroundColor: t.colors.surface, borderRadius: t.radius.control, paddingHorizontal: 12, paddingVertical: 7, ...t.shadow.sm },
    ...
    docsCard: { backgroundColor: t.colors.surface, borderRadius: t.radius.sheet, borderWidth: 1, borderColor: t.colors.hairline, paddingHorizontal: t.spacing.base, ...t.shadow.sm },
    ...
    docIcon: { width: 44, height: 44, borderRadius: t.radius.control, backgroundColor: t.colors.surfaceAlt, alignItems: 'center', justifyContent: 'center' },
    docName: { flex: 1, fontFamily: t.fontFamily.bold, fontSize: 15, color: t.colors.text, textAlign: 'right' },
    docStatus: { flexDirection: 'row-reverse', alignItems: 'center', gap: 5, paddingHorizontal: 8, paddingVertical: 4, borderRadius: t.radius.pill },
