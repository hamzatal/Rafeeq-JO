...
const makeStyles = (t: AppTheme) =>
  StyleSheet.create({
    ...
    method: { flexDirection: 'row-reverse', alignItems: 'center', gap: t.spacing.md, backgroundColor: t.colors.card, borderRadius: t.radius.xl, padding: t.spacing.base, marginBottom: t.spacing.md, ...t.shadow.sm },
