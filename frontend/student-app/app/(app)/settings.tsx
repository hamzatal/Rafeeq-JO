...
export default function Settings() {
  ...
  const links: { icon: IconName; label: string; href: string }[] = [
    ...
    { icon: 'map-pin', label: t('addresses.title'), href: '/(app)/addresses' },
    { icon: 'alert-triangle', label: t('emergency.title'), href: '/(app)/emergency' },
...
const makeStyles = (t: AppTheme) =>
  StyleSheet.create({
    ...
    avatar: { width: 76, height: 76, borderRadius: 38, backgroundColor: t.colors.primary, alignItems: 'center', justifyContent: 'center', marginBottom: t.spacing.sm, ...t.shadow.md },
    avatarText: { fontFamily: t.fontFamily.extrabold, fontSize: 32, color: t.colors.onPrimary },
