...
/**
 * Minimal, professional tab bar (no colored pills). Each tab is a quiet
 * icon + label; the active one is tinted with the brand color and marked by a
 * thin top indicator — the restrained style used by world-class apps.
 */
