...
/**
 * Rafeeq modern tab bar (v4): the active item expands into a soft "pill" with
 * an inline label, while inactive items are clean icon-only. The pill animates
 * on selection via LayoutAnimation — a small touch of motion / soul.
 */
export function TabBar({ state, descriptors, navigation }: BottomTabBarProps) {
  ...
  // Only render real tabs (hidden href:null routes have no tabBarIcon).
