...
> الحالة الحيّة والتفصيلية: `docs/EXECUTION_PLAN.md` (M1–M10) + `docs/PROGRESS.md`. كتالوج المزايا الشامل: `docs/FEATURES.md`. **التشغيل والربط: `docs/RUNNING.md`.** آخر commit: **RFQ-193**.
