...
![Tests](https://img.shields.io/badge/tests-273%20backend%20%2B%2027%20frontend-047857?style=flat-square)
...
<img src="docs/design/readme/android-limits.png" alt="الفئة الاقتصادية مقابل الأعلى على أندرويد" width="100%" />
...
وطبقة الجهاز أندرويدية لا آيفون: شريط حالة بنسبة بطارية، وثقب كاميرا لا شقّ،
و**شريط تنقّل يأكل من ارتفاع التطبيق فعلاً** — 24dp للإيماءة و**48dp للأزرار الثلاثة**.

| الجهاز | المقاس | المتاح للتطبيق | لماذا هو في القائمة |
|---|---|---|---|
| **Galaxy A15 / A25** | `360×800 @3x` | 748dp | الأكثر شيوعاً بين طلاب الأردن |
| **Redmi Note 13** | `393×873 @2.75x` | 821dp | شاشة أطول بنسبة 20:9 |
| **Galaxy A05 / A03** | `360×740 @2x` | **664dp** | الفئة الاقتصادية — **نقطة الاختبار الحرجة** |
| **Pixel 8a** | `412×915 @2.63x` | 863dp | أندرويد الأصلي · الحدّ الأعلى |

**الفارق 23٪ بين الأدنى والأعلى**، وأي تصميم يُختبر على الأعلى وحده سينكسر على الأدنى —
وهو الأكثر انتشاراً. وهذا ما أثبتته المحاكاة فعلاً:

| ما أظهرته المحاكاة | العلاج |
|---|---|
| **زرّ «اطلب الآن» كان مأكولاً بشريط الأزرار** على الجهاز الاقتصادي — لأنّ الشيت مرتكز `bottom:0` وشريط التنقّل يرسم فوقه | الشيت يحترم `safe-area inset`: التصميم يُقاس إلى `الارتفاع − شريط التنقّل`، وهو ما يعطيه `useSafeAreaInsets()` |
| **التحكّم 46dp يهبط إلى 42dp** عند مقياس `0.923×` — **تحت الحدّ 44** | الارتفاعات الحرجة تُثبَّت بـ`dp` **مطلق**. الذي يُقاس هو **المسافات** لا أهداف اللمس. بند في المرحلة 7 |
| خلفية السبلاش يجب أن تطابق `windowSplashScreenBackground` | وإلّا ظهرت **وميضة** عند الإقلاع |

الصفائح كاملة: [`android`](docs/design/readme/android.png) · [`android-2`](docs/design/readme/android-2.png) · [`android-limits`](docs/design/readme/android-limits.png)
...
| [`docs/DATABASE.md`](docs/DATABASE.md) | **قاعدة البيانات** — 68 جدولاً · قرارات المعرّفات والمال والحذف · الفجوات المقيسة |
| [`docs/DATABASE_SCHEMA.generated.md`](docs/DATABASE_SCHEMA.generated.md) | **مُولَّد** من السكيما الحيّة · كل عمود وفهرس |
| [`docs/MARKETING.md`](docs/MARKETING.md) | **التسويق** — 12 قالباً بمقاساته · تقويم 8 أسابيع · الإعلانات · الأرقام التي تُقاس |
